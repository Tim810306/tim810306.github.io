    ...
    (function (module, exports, __webpack_require__) {
      ...
      var Clipboard = function (_Emitter) {
        ...
        function Clipboard(trigger, options) {
          ...
          var _this = _possibleConstructorReturn(this, (Clipboard
            .__proto__ || Object.getPrototypeOf(Clipboard)).call(
            this));
        ...
        _createClass(Clipboard, [{
          ...
          value: function resolveOptions() {
            var options = arguments.length > 0 && arguments[
            ...
            this.container = _typeof(options.container) ===
          ...
          value: function onClick(e) {
            ...
            this.clipboardAction = new _clipboardAction2
              .default({
          ...
          value: function isSupported() {
            var action = arguments.length > 0 && arguments[
              0] !== undefined ? arguments[0] : ['copy', 'cut'];
      ...
      var ClipboardAction = function () {
        ...
        _createClass(ClipboardAction, [{
          ...
          value: function selectFake() {
            var _this = this;
            var isRTL = document.documentElement.getAttribute(
              'dir') == 'rtl';
            this.removeFake();
            ...
            this.fakeHandler = this.container.addEventListener(
              'click', this.fakeHandlerCallback) || true;
            ...
            var yPosition = window.pageYOffset || document
              .documentElement.scrollTop;
            this.fakeElem.style.top = yPosition + 'px';
            this.fakeElem.setAttribute('readonly', '');
            this.fakeElem.value = this.text;
            this.container.appendChild(this.fakeElem);
            this.selectedText = (0, _select2.default)(this
              .fakeElem);
            this.copyText();
          }
          /**
          ...
          set: function set(target) {
              if (target !== undefined) {
                if (target && (typeof target === 'undefined' ?
                    'undefined' : _typeof(target)) === 'object' &&
                  target.nodeType === 1) {
                  if (this.action === 'copy' && target
                    .hasAttribute('disabled')) {
                    throw new Error(
                      'Invalid "target" attribute. Please use "readonly" instead of "disabled" attribute'
                      );
                  }
                  if (this.action === 'cut' && (target
                      .hasAttribute('readonly') || target
                      .hasAttribute('disabled'))) {
                    throw new Error(
