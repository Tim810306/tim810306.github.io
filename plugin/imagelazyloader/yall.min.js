var yall = function () {
  ...
  return function (e) {
    var n = (e = e || {}).lazyClass || "lazy",
      ...
      d = [],
      l = function (e, t) {
        return d.slice.call((t || document).querySelectorAll(e || "img." +
          n + ",video." + n + ",iframe." + n + ",." + o))
      },
      f = function (n) {
        var t, r, i = n.parentNode;
        for (var a in "PICTURE" == i.nodeName && (r = i), "VIDEO" == n
            .nodeName && (r = n), t = l("source", r)) b(t[a]);
        b(n), n.autoplay && n.load();
        var s = n.classList;
        s.contains(o) && (s.remove(o), s.add(e.lazyBackgroundLoaded ||
          "lazy-bg-loaded"))
      },
      v = function (e) {
        for (var n in i) e.addEventListener(n, i[n].listener || i[n], i[n]
          .options || void 0);
        h.observe(e)
      },
      b = function (e) {
      ...
      g = l();
    if (/baidu|(?:google|bing|yandex|duckduck)bot/i.test(navigator
        .userAgent))
        ...
        e.forEach(function (e) {
          if (e.intersectionRatio) {
            ...
            s in a && t ? a[s](function () {
              ...
              timeout: t
            }) : f(i), i.classList.remove(n), o.unobserve(i), (g =
              g.filter(function (e) {
                return e != i
      ...
      }).observe(l(e.observeRootSelector || "body")[0], e
